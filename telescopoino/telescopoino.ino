...
StepperControl control(StepperControl::DefaultStepCount, 37,35,33,31);
...
void go_up(){                             // in questo Sketch l'incremento è semplicemente aritmetico, in realtà deve provenire
  h_tel++;                                // da una lettura dei dati dell'encoder, oppure per le montature sprovviste, dal
